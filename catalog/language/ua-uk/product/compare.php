...
// Text
$_['text_product']      = 'Відомості про продукт';
$_['text_name']         = 'Продукт';
...
$_['text_success']      = 'Успішно: Виберіть <a href="%s"> %s</a> до вашого <a href="%s">порівняння продуктів</a>!';
$_['text_remove']       = 'Успішно: Змінено порівняння продуктів!';
$_['text_empty']        = 'Ви не вибрали будь-які продукти для порівняння.';